...
public class DrawableImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private void init(Context context) {
        ...
        if (context instanceof Activity) {
            ...
            mScaleGestureDetector = new ScaleGestureDetector(mHostActivity,
                    new ScalingTextureView.ScaleListener());
    ...
    private Bitmap resizeBitmap(Drawable drawable, Bitmap currentBitmap, float scale) {
        Bitmap bitmap = null;
    ...
    private void drawingStarted() {
        if (mHostActivity != null) {
            if (mHostActivity instanceof magnifier) {
                ((magnifier) mHostActivity).hideStillshotWidgets();
            }
        }
    }
    ...
    private void drawingStopped() {
        if (mHostActivity != null) {
            if (mHostActivity instanceof magnifier) {
                ((magnifier) mHostActivity).showStillshotWidgets();
            }
        }
        removeCircle();
    }
    ...
    public void enlargeTrashIcon() {
        if (mHostActivity instanceof magnifier) {
            ((magnifier) mHostActivity).setTrashIconSize(TRASH_ICON_ENLARGED_SIZE, TRASH_ICON_ENLARGED_SIZE);
        }
    }

    public void shrinkTrashIcon() {
        if (mHostActivity instanceof magnifier) {
            ((magnifier) mHostActivity).setTrashIconSize(TRASH_ICON_NORMAL_SIZE, TRASH_ICON_NORMAL_SIZE);
        }
    }
